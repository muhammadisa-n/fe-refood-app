      ...
      <div className="pt-4 border-b border-white/40">
        ...
        <div className="flex items-center justify-between gap-3 py-4 cursor-pointer">
          ...
          >
            ...
            <p className="text-base leading-5 text-white">My Product</p>
          </Link>
        </div>
      </div>
      <div className="pt-4 border-b border-white/40">
        ...
        <div className="flex items-center justify-between gap-3 py-4 cursor-pointer">
          ...
          >
            ...
            <p className="text-base font-normal leading-5 text-white">Orders</p>
          </Link>
        </div>
      </div>
      <div className="pt-4 border-b border-white/40">
        ...
        <div className="flex items-center justify-between gap-3 py-4 cursor-pointer">
          <Link to="/my-dashboard/profile" className="flex items-center gap-3">
      ...
      <div className="pt-4 border-b border-white/40">
        <div className="flex items-center justify-between gap-3 py-4 cursor-pointer">
          <button onClick={HandleLogout} className="flex items-center gap-3">
            ...
            <p className="text-base font-normal leading-5 text-white">Logout</p>
          </button>
        </div>
      </div>
    </div>
